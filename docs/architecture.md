...
| **MinIO** | `quay.io/minio/minio` | S3-compatible object storage for file blobs |
| **minio-init** | `quay.io/minio/mc` | Creates the read-only blob-download user and sets the bucket policy |
